...
function TableOfContentsSkeleton() {
  return (
    <nav className="text-sm w-64 ml-4 max-h-[calc(100vh-8rem)] overflow-y-auto animate-pulse">
      <div className="h-7 bg-gray-200 dark:bg-gray-800 rounded w-16 mb-4"></div>
  ...
  return (
    <div className="w-full animate-pulse">
      <div className="inline-flex items-center mb-6">
        <div className="w-4 h-4 mr-2 bg-gray-200 dark:bg-gray-800 rounded"></div>
        <div className="h-4 w-32 bg-gray-200 dark:bg-gray-800 rounded"></div>
      </div>
      
      <div className="aspect-[2/1] w-full bg-gray-200 dark:bg-gray-800 rounded-lg mb-6"></div>
      ...
      <div className="mb-10">
        ...
        <div className="h-9 sm:h-10 md:h-12 bg-gray-200 dark:bg-gray-800 rounded-lg w-3/4 mb-4"></div>
        <div className="h-9 sm:h-10 bg-gray-200 dark:bg-gray-800 rounded-lg w-1/2 mb-6"></div>
        
        <div className="mt-8 flex items-center border-b border-gray-200 dark:border-gray-700 pb-8">
          <div className="h-12 w-12 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-600 text-sm font-medium">YJ</div>
      ...
      <div className="space-y-6 my-8">
        <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded-lg w-11/12 mb-3"></div>
        
        <div className="space-y-3">
          {[1, 0.9, 1, 0.95, 0.85].map((width, i) => (
            <div key={i} className="h-4 bg-gray-200 dark:bg-gray-800 rounded" style={{ width: `${width * 100}%` }}></div>
          ))}
        </div>
        ...
        <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded-lg w-3/5 mb-3"></div>
        <div className="space-y-3">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-8 pb-4">
        <div className="flex items-center">
          <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-600 text-sm font-medium">YJ</div>
          <div className="ml-4 space-y-2">
            <div className="h-5 w-24 bg-gray-200 dark:bg-gray-800 rounded"></div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="col-span-1">
            <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 h-24">
              <div className="mb-1 h-3 bg-gray-200 dark:bg-gray-800 rounded w-16"></div>
              <div className="flex items-center mt-3">
                <div className="mr-3 w-5 h-5 bg-gray-200 dark:bg-gray-800 rounded"></div>
          ...
          <div className="col-span-1">
            <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 h-24">
              <div className="mb-1 h-3 bg-gray-200 dark:bg-gray-800 rounded w-16 ml-auto"></div>
              <div className="flex items-center justify-end mt-3">
                <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded w-4/5"></div>
                <div className="ml-3 w-5 h-5 bg-gray-200 dark:bg-gray-800 rounded"></div>
              </div>
            </div>
          </div>
        </div>
