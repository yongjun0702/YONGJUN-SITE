...
export const projectsData: Project[] = [
  {
    ...
    introduction: '한국철도기술연구원 <철도산업 디지털 및 친환경 분야 핵심기술 개발>(과제코드: PK2503D2) 연구 과제의 일환으로 진행한 프로젝트로, 대중교통 경로 탐색 및 접근성 분석을 통해 사용자에게 효율적인 이동 경로를 제공하고 지역별 대중교통 접근성을 시각화하는 플랫폼입니다. 기존의 단순 물리적 거리 기반 접근성 분석의 한계를 극복하고, 실제 이동 소요 시간과 시간대별 대중교통 상황을 고려한 분석이 가능합니다.',
    date: '2025-02-03',
  ...
  },
  {
    ...
    introduction: '대학생들의 팀 프로젝트와 모임을 위한 애플리케이션입니다. 각자 다른 시간표에서 모두가 비어있는 공강 시간을 자동으로 찾아줍니다. AI 기술로 시간표 사진을 분석하고, 그룹원 전체의 겹치는 빈 시간을 계산해 최적의 만남 시간을 다양한 UI로 제공합니다. 현재 iOS 및 Android 스토어에 출시되어 약 100명의 사용자를 확보했습니다.',
    date: '2024-06',
  ...
  },
  {
    ...
    introduction: '같은 방향으로 가는 사람들과 빠르게 매칭하고, 합리적인 비용으로 편하게 이동할 수 있는 모바일 택시팟 플랫폼입니다. 위치 기반 서비스를 통해 실시간으로 택시팟을 찾고 자유로운 매칭 및 채팅 시스템을 제공합니다. Google Play 및 App Store 베타 테스트 진행 중 입니다.',
    date: '2025-01',
    ...
    images: ['/images/projects/letsmerge_01.png', '/images/projects/letsmerge_02.png', '/images/projects/letsmerge_03.png'],
